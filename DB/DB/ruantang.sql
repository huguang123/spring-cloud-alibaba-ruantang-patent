...
CREATE TABLE `tenant`  (
  ...
  `tenant_type` int NOT NULL COMMENT '租户属性（1：平台管理租户、2：企业商户租户、3：代理所租户）',
...
CREATE TABLE `tenant_template`  (
  ...
  `templateDesc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户模板描述',
  `create_time` bigint NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` bigint NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
